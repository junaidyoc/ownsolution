...
class ElementsKit_Section_Effect_Controls{
    ...
    public function register_controls($control, $args)
    {
        ...
        $control->add_control(
            ...
            [
                'label' => esc_html__('Background Image Parallax', 'seocify'),
        ...
        $repeater->add_control(
            ...
            'default' => 'animation',
            'options' => [
                'animation' => esc_html__('Css Animation', 'seocify'),
                'mousemove' => esc_html__('Mouse Move', 'seocify'),
                'onscroll' => esc_html__('On Scroll', 'seocify'),
                'tilt' => esc_html__('Parallax Tilt', 'seocify'),
            ],
        ]
        );
        $repeater->add_control(
            'item_source',
            [
                'label' => esc_html__( 'Item source', 'seocify' ),
        ...
        $repeater->add_control(
            'image',[
                'label' => esc_html__('Choose Image', 'seocify'),
        ...
        $repeater->add_control(
            'shape',  [
                'label' => esc_html__('Choose Shape', 'seocify'),
                'type' => Controls_Manager::SELECT,
                'default' => 'angle',
                'options' => [
                    'angle' => esc_html__('Shape 1', 'seocify'),
                    'double_stroke' => esc_html__('Shape 2', 'seocify'),
                    'fat_stroke' => esc_html__('Shape 3', 'seocify'),
                    'fill_circle' => esc_html__('Shape 4', 'seocify'),
                    'round_triangle' => esc_html__('Shape 5', 'seocify'),
                    'single_stroke' => esc_html__('Shape 6', 'seocify'),
                    'stroke_circle' => esc_html__('Shape 7', 'seocify'),
                    'triangle' => esc_html__('Shape 8', 'seocify'),
                    'zigzag' => esc_html__('Shape 9', 'seocify'),
                    'zigzag_2' => esc_html__('Shape 10', 'seocify'),
                    'shape_1' => esc_html__('Shape 11', 'seocify'),
                    'shape_2' => esc_html__('Shape 12', 'seocify'),
                    'shape_3' => esc_html__('Shape 13', 'seocify'),
                    'shape_4' => esc_html__('Shape 14', 'seocify'),
                ],
                'condition' => [
                    'item_source' => 'shape',
                ]
        ...
        $repeater->add_responsive_control(
            'width_type',
            [
                'label' => esc_html__( 'Width', 'seocify' ),
                'type' => Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => esc_html__( 'Auto', 'seocify' ),
                    'custom' => esc_html__( 'Custom', 'seocify' ),
                ],
        ...
        $repeater->add_responsive_control(
            'custom_width',
            [
                'label' => esc_html__( 'Custom Width', 'seocify' ),
        ...
        $repeater->add_responsive_control(
            'pos_x', [
                'label' => esc_html__('Position X (%)', 'seocify'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%','px'],
                'range' => [
                    '%' => [
        ...
        $repeater->add_responsive_control(
            'pos_y',[
                'label' => esc_html__('Position Y (%)', 'seocify'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['%','px'],
                'range' => [
                    '%' => [
        ...
        $repeater->add_control(
            'item_opacity',
            [
                'label' => esc_html__( 'Opacity', 'seocify' ),
        ...
        $repeater->add_control(
            'animation_speed',
            [
                'label' => esc_html__( 'Animation speed', 'seocify' ) . ' (s)',
                'type' => Controls_Manager::NUMBER,
                'default' => '5',
                'min' => 1,
                'step' => 100,
        ...
        $repeater->add_control(
            'zindex',   [
                'label' => esc_html__('Z-index', 'seocify'),
                'type' => Controls_Manager::NUMBER,
