...
<header class="header-style3 xs-header header-main">
    <div class="container-fluid">
        <div class="navbar">
            ...
            <ul class="xs-menu-tools <?php echo esc_attr( $nav_tools_show_mobile === true ? 'xs-menu-tools-mobile' : '' ) ?>">
                <?php if ($nav_lang):
                ...
                <?php if(class_exists( 'woocommerce' )): ?>
                    <li class="woo_cart_url display-mobile">
                        <a href="<?php echo esc_url(wc_get_page_permalink('cart')); ?>" class="woo_cart_url">
